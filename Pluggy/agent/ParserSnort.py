...
class SnortUnified:
    ...
    U2_TYPE_IDS_EVENT_VLAN = 104
    U2_TYPE_IDS_EVENT_IPV6_VLAN = 105
    U2_TYPE_EXTRA_DATA = 110
    ...
    U2_RECORD_TYPES = [U2_TYPE_EVENT, \
                       ...
                       U2_TYPE_IDS_EVENT_IPV6_VLAN, \
                       U2_TYPE_IDS_EVENT_VLAN,\
                       U2_TYPE_EXTRA_DATA]
#
# 
#
class EventSnort:
    ...
    def addevent(self, t, data):
        if self._unified_version == 1:
            ...
            elif t == SnortUnified.U2_TYPE_IDS_EVENT_VLAN:
                #TODO
                pass
            elif t in [SnortUnified.U2_TYPE_IDS_EVENT_IPV6,SnortUnified.U2_TYPE_IDS_EVENT_IPV6_MPLS,SnortUnified.U2_TYPE_IDS_EVENT_IPV6_VLAN]:
                #TODO
                pass
            elif t in [SnortUnified.U2_TYPE_IDS_EVENT_MPLS,SnortUnified.U2_TYPE_EXTRA_DATA]:
                pass
            ...
            if (pos + self.UX_SIZERECORDHDR) <= self._filesize:
                ...
                if pos + size <= self._filesize:
                    ...
                    if self._unified_version == 1:
                        ...
                        if type in [SnortUnified.U2_TYPE_EVENT,  SnortUnified.U2_TYPE_IDS_EVENT,  SnortUnified.U2_TYPE_IDS_EVENT_IPV6,  SnortUnified.U2_TYPE_IDS_EVENT_MPLS,  SnortUnified.U2_TYPE_IDS_EVENT_IPV6_MPLS,  SnortUnified.U2_TYPE_IDS_EVENT_IPV6_VLAN, SnortUnified.U2_TYPE_IDS_EVENT_VLAN,  SnortUnified.U2_TYPE_EXTRA_DATA]:
